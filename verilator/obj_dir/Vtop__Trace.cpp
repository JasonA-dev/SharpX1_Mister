...
void Vtop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+70,(vlTOPp->top__DOT__sharpx1__DOT__romDo_Sharpx1),8);
        tracep->chgSData(oldp+71,(vlTOPp->top__DOT__sharpx1__DOT__romA),14);
        tracep->chgBit(oldp+72,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__clock));
        tracep->chgBit(oldp+73,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__ce));
        tracep->chgCData(oldp+74,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__data_out),8);
        tracep->chgSData(oldp+75,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__a),13);
        tracep->chgBit(oldp+76,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__clock));
        tracep->chgBit(oldp+77,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__ram_cs));
        tracep->chgBit(oldp+78,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__wren_a));
        tracep->chgSData(oldp+79,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__address_a),16);
        tracep->chgCData(oldp+80,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__data_a),8);
        tracep->chgCData(oldp+81,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__q_a),8);
        tracep->chgBit(oldp+82,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__ram_cs_b));
        tracep->chgBit(oldp+83,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__wren_b));
        tracep->chgSData(oldp+84,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__address_b),16);
        tracep->chgCData(oldp+85,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__data_b),8);
        tracep->chgCData(oldp+86,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__q_b),8);
    }
}
