...
void Vtop::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+88,"top sharpx1 bios_fw_spi DW", false,-1, 31,0);
        tracep->declBus(c+89,"top sharpx1 bios_fw_spi AW", false,-1, 31,0);
        tracep->declArray(c+90,"top sharpx1 bios_fw_spi FN", false,-1, 223,0);
        tracep->declBit(c+73,"top sharpx1 bios_fw_spi clock", false,-1);
        tracep->declBit(c+74,"top sharpx1 bios_fw_spi ce", false,-1);
        tracep->declBus(c+75,"top sharpx1 bios_fw_spi data_out", false,-1, 7,0);
        tracep->declBus(c+76,"top sharpx1 bios_fw_spi a", false,-1, 12,0);
        tracep->declBus(c+88,"top sharpx1 dpram data_width_g", false,-1, 31,0);
        tracep->declBus(c+97,"top sharpx1 dpram addr_width_g", false,-1, 31,0);
        tracep->declBit(c+77,"top sharpx1 dpram clock", false,-1);
        tracep->declBit(c+78,"top sharpx1 dpram ram_cs", false,-1);
        tracep->declBit(c+79,"top sharpx1 dpram wren_a", false,-1);
        tracep->declBus(c+80,"top sharpx1 dpram address_a", false,-1, 15,0);
        tracep->declBus(c+81,"top sharpx1 dpram data_a", false,-1, 7,0);
        tracep->declBus(c+82,"top sharpx1 dpram q_a", false,-1, 7,0);
        tracep->declBit(c+83,"top sharpx1 dpram ram_cs_b", false,-1);
        tracep->declBit(c+84,"top sharpx1 dpram wren_b", false,-1);
        tracep->declBus(c+85,"top sharpx1 dpram address_b", false,-1, 15,0);
        tracep->declBus(c+86,"top sharpx1 dpram data_b", false,-1, 7,0);
        tracep->declBus(c+87,"top sharpx1 dpram q_b", false,-1, 7,0);
    }
}
...
void Vtop::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+73,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__clock));
        tracep->fullBit(oldp+74,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__ce));
        tracep->fullCData(oldp+75,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__data_out),8);
        tracep->fullSData(oldp+76,(vlTOPp->top__DOT__sharpx1__DOT__bios_fw_spi__DOT__a),13);
        tracep->fullBit(oldp+77,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__clock));
        tracep->fullBit(oldp+78,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__ram_cs));
        tracep->fullBit(oldp+79,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__wren_a));
        tracep->fullSData(oldp+80,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__address_a),16);
        tracep->fullCData(oldp+81,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__data_a),8);
        tracep->fullCData(oldp+82,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__q_a),8);
        tracep->fullBit(oldp+83,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__ram_cs_b));
        tracep->fullBit(oldp+84,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__wren_b));
        tracep->fullSData(oldp+85,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__address_b),16);
        tracep->fullCData(oldp+86,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__data_b),8);
        tracep->fullCData(oldp+87,(vlTOPp->top__DOT__sharpx1__DOT__dpram__DOT__q_b),8);
        tracep->fullIData(oldp+88,(8U),32);
        tracep->fullIData(oldp+89,(0xdU),32);
        ...
        tracep->fullWData(oldp+90,(__Vtemp2),224);
        tracep->fullIData(oldp+97,(0x10U),32);
    }
}
